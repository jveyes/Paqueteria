#!/usr/bin/env python3
"""
Enviar mensaje de prueba al número 3002596319
"""
...
async def send_test_to_3002596319():
    """Enviar mensaje de prueba al número 3002596319"""
    print("📱 ENVIANDO MENSAJE DE PRUEBA AL NÚMERO 3002596319")
    print("=" * 60)
    ...
    # Número de destino
    target_number = "3002596319"
    formatted_number = "573002596319"
                    ...
                    if token:
                        ...
                        async with session.post(
                            ...
                            if sms_response.status == 200:
                                ...
                                print("   1. Revisa tu teléfono 3002596319")
...
if __name__ == "__main__":
    asyncio.run(send_test_to_3002596319())
