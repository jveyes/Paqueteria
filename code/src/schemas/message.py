...
class CustomerInquiryCreate(BaseModel):
    ...
    customer_email: Optional[str] = Field(None, max_length=100, description="Email del cliente")
    ...
    content: str = Field(..., min_length=3, max_length=2000, description="Contenido de la consulta")
